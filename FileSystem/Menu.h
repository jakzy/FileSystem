...
static vector<string> menu_ROfile = { "1. Show file", "CTRL+Z to go to FILE menu" };
...
static vector<string> menu_ENC_access = { "1. Share access for a new user",  "2. Delete access rights for a user", "CTRL+Z to go to FILE menu" };
